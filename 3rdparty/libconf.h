...
// #define LIGHTMODBUS_BIG_ENDIAN // 系统是大端模式时使用
#define LIGHTMODBUS_STATIC_MEM_MASTER_REQUEST 256
#define LIGHTMODBUS_STATIC_MEM_MASTER_RESPONSE 256
#define LIGHTMODBUS_STATIC_MEM_MASTER_DATA 256
